...
--powerups, custom colors, descriptions
powerups = {}
powerups[0x00] = {}
...
if(memory.readbyte(pauseAdd) == 0x25) then
	...
	if(ramwatch) then
		...
		for i=1,12 do
			gui.text(51+(pauseLevel>0 and 16 or 0),32+(i*8),pauseText[i],pauseLevel>0 and pauseColor[pauseLevel] or pauseColor[i],"clear")
		end
